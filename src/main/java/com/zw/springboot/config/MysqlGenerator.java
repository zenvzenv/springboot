...
public class MysqlGenerator {
    private static final String PACKAGE_NAME = "com.zw.springboot";
    private static final String MODULE_NAME = "auto";
    private static final String OUT_PATH = "C:/img/";
    private static final String AUTHOR = "zwzw";
    private static final String DRIVER = "com.mysql.jdbc.Driver";
    private static final String URL = "jdbc:mysql://localhost:3306/springboot_test?useUnicode=true&characterEncoding=UTF-8&useSSL=false&serverTimezone=GMT%2B8";
